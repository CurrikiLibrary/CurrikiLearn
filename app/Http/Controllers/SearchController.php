...
class SearchController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $query = Group::find(env('NASSAU_HUB_ID'))->resources()->whereDoesntHave('collection');
        ...
        $groups = Group::where('parent_id', env('NASSAU_HUB_ID'))->orWhere('id', env('NASSAU_HUB_ID'))->get(); // Hardcoding groups with BOCES group as parent

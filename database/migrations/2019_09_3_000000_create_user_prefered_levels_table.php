...
class CreateUserPreferedLevelsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_prefered_levels', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('user_prefered_levels');
    }
}

...
<body>
	...
	<div class="head-block layout-sm">
		<div class="container head-block-inner">
			<img class="logo-brand" src="{{ asset('images/' . (env('NASSAU_HUB_ID') == 1 ? 'logo.jpg' : 'NEAF-logo-cmyk.jpg')) }}" width="491" height="218" alt="{{ env('APP_NAME') }} Curriculum Writing Projects">
		</div>
	</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content modal-form">
				...
				<div class="login-logo-container">
					<img src="{{asset('images/' . (env('NASSAU_HUB_ID') == 1 ? 'logo_boces.jpg' : 'NEAF-logo-cmyk.jpg'))}}" width="172" height="66" alt="{{ env('APP_NAME') }} Curriculum Writing Projects">
				</div>

            ...
            <div class="container-fluid">
                ...
                <div class="filters">
                    <div class="row-fluid">
                        <div class="span4">
                            <?php if ($upload_files) { ?>
                                <button class="btn btn-inverse upload-btn" style="margin-left:5px;" onclick="$('#myAwesomeDropzone').click();"><i class="icon-upload icon-white"></i> <?php echo lang_Upload_file ?></button> 
                            <?php } ?>
                                                    ...
                                                    <figcaption>
                                                        <a href="javascript:void('')"
                                                           ...
                                                           <?php if ($delete_folder) { ?>onclick="if (confirm('<?php echo lang_Confirm_Folder_del; ?>')) {
                                                                                        delete_folder('<?php echo $root . $cur_dir . $file; ?>', '<?php echo $thumbs_path . $subdir . $file; ?>');
                                                                                        $(this).parent().parent().parent().hide(200);
                                                                                        return false;
                                                                                    }"<?php } ?> title="<?php echo lang_Erase ?>">
...
function selectFile(file_path){
        ...
        url = args.url;
        type = args.type;
        org_win = args.org_win;
                                
        org_win.document.getElementById(field_name).value = file_path; 

...
if($_SERVER['HTTP_HOST'] == 'localhost'){
	...
	$upload_dir = '/curriki_svn/trunk/tinymce/uploads/'; // path from base_url to upload base dir
}else{
	$base_url="http://cg.curriki.org/"; //url base of site if you want only relative url leave empty

...
tinymce.PluginManager.add('fileuploader', function (editor, url) {
    ...
    var imported = document.createElement('script');
    imported.src = url + '/../../../dropzone.js';
    document.head.appendChild(imported);

    var imported = document.createElement('link');
    imported.href = url + '/../../../../css/dropzone.css';
    imported.rel = 'stylesheet';
    document.head.appendChild(imported);

    /****************Adding modal for folder uploads ******************/
    $folderUploadModal = `<div class="modal fade bd-example-modal-lg" id="folderUploadModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id="dropzoneDiv" class="needsclick">
                        <div class="dz-message needsclick">
                            Drag and drop folder here to upload files.<br />
                        </div>
                    </div>
                </div>
            </div>
    ...
    jQuery("body").append($folderUploadModal);
    ...
    $form += 'action="' + CURRIKI_API_URL + 'wp-content/themes/genesis-curriki/js/tinymce_4.3.2_jquery/plugins/fileuploader/upload.php" style ="display:none;">';
    ...
    function beforeSubmit() {
        ...
        jQuery(this)[0].messageWindow = editor.windowManager.open({
            title: 'File uploading. This may take a minute for large files. ',
            type: 'container',
            html: $html,
            classes: 'filemanager',
            width: 720,
    ...
    function uploadFolderDialog() {
        if (!$("div#dropzoneDiv").hasClass("dropzone")) {
            $( "div#dropzoneDiv" ).addClass("dropzone");

            $("div#dropzoneDiv").dropzone({
                url: CURRIKI_API_URL + 'wp-content/themes/genesis-curriki/js/tinymce_4.3.2_jquery/plugins/fileuploader/upload.php',
                init: function() {
                    ...
                    this.on("success", function(file, responseText) {
                        ...
                        if (data.status == 1) {
                            ...
                            $(file.previewElement).addClass("dz-error").find('.dz-error-message').text(data.error);
                        }
                    });
...
tinymce.PluginManager.requireLangPack('fileuploader', 'es,fi,ja');
